...
void SeperateFile(string fileString, DataTree * Tree)
{
	...
	while (Ustr != NULL)
	{
		...
		case 7:
			str8 = Ustr;
			T = Tree->root;
			Tree->root = Tree->InsertNode(str1, str2, str3, str4, str5, str6, str7, str8, T);
			break;
		}
...
int main()
{
	...
	while (choice != -1)
	{
		...
		if (choice == 1)
		{
			...
			Tree->DeleteTotal = 0;
			auto start = high_resolution_clock::now();
			Tree->PostOrderTreeDeletion(Tree->root);
		...
		else if (choice == 2)
		{
			...
			if (choice == 1)
			{
				...
				T = Tree->root;
				auto start = high_resolution_clock::now();
				Tree->PhoneDeleteNode(Tree->root, Phone);
				auto stop = high_resolution_clock::now();
				auto duration = duration_cast<microseconds>(stop - start);
				cout << "The time used for excution is: " << duration.count() << " microseconds" << endl;
			}
		...
		else if (choice == 3)
		{
			...
			if (choice == 1 || (choice >= 5 && choice <= 7))
			{
				...
				if (choice == 1)
				{
					//T = Tree->root;
					auto start = high_resolution_clock::now();
					Tree->PhoneSearch(Tree->root, Phone);
					auto stop = high_resolution_clock::now();
					auto duration = duration_cast<microseconds>(stop - start);
					cout << "The time used for excution is: " << duration.count() << " microseconds" << endl;
				}
				if (choice == 5)
				{
					...
					T = Tree->root;
					auto start = high_resolution_clock::now();
					Tree->DoubleSearchPhone(Tree->root, Phone, str1, choice);
					auto stop = high_resolution_clock::now();
					auto duration = duration_cast<microseconds>(stop - start);
					cout << "The time used for excution is: " << duration.count() << " microseconds" << endl;
				}
			...
			else if (choice == 2 || choice == 8 || choice == 9)
			{
				...
				{
					T = Tree->root;
					Tree->SkillsSearch(Tree->root, str1);
				}
				else if (choice == 8)
				{
					cout << "Please type in the Job Title: ";
					...
					T = Tree->root;
					auto start = high_resolution_clock::now();
					Tree->DoubleSearchXPhone(Tree->root, str1, str2, choice);
					auto stop = high_resolution_clock::now();
					auto duration = duration_cast<microseconds>(stop - start);
					cout << "The time used for excution is: " << duration.count() << " microseconds" << endl;
				}
			...
			else if (choice == 4)
			{
				...
				T = Tree->root;
				auto start = high_resolution_clock::now();
				Tree->CountrySearch(Tree->root, str1);
				auto stop = high_resolution_clock::now();
				auto duration = duration_cast<microseconds>(stop - start);
				cout << "The time used for excution is: " << duration.count() << " microseconds" << endl;
			}
